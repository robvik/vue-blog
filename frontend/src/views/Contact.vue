<template>
  <div class="wrapper">
    ...
    <div class="main-container">
      <div>
        <!-- Header -->
        <h3 class="text-2xl font-Lato text-gray-700 font-bold mb-6 text-center lg:text-left">Contact</h3> 
        ...
        <!-- Body -->
        <p class="text-lg text-justify text-gray-800 my-8">Contact text...</p>
